...
<p>
  ...
  <img src="ss/07_search_suggestions.png" width="30%" alt="Live search suggestions" />
...
Top row: search, suggestions, library. Below: video player, audio player, downloads. Settings is in [ss/04_settings.png](ss/04_settings.png).
