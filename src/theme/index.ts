...
// Design tokens from "TubeVault Theme.dc.html" (claude.ai/design).
// Accent hues converted from oklch: dark oklch(70% .19 25) → #ff645f,
// light oklch(58% .2 25) → #d73337 (RN has no oklch() support).
...
// The tab bar is translucent and absolutely positioned so content blurs
// through it, so scrollable content has to reserve its height itself.
// ponytail: flat constant matching the design's 84px bar; swap for
// useBottomTabBarHeight() if a device ever needs a taller bar than this.
